...
const CartPage = () => {
    ...
    const [shippingFom, setShippingForm] = useState<ShippingFormInputs>();
    ...
    return (
        <div className="flex flex-col gap-8 items-center justify-center mt-12">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                {steps.map((step) => (
                    <div key={step.id} className={`flex items-center gap-2 border-b-2 pb-3 ${step.id===activeStep ? "border-gray-800" : "border-gray-200"}`}>
                        ...
                        <p className={`text-sm font-semibold ${step.id === activeStep?"text-gray-800" : "text-gray-400"}`}>{step.title}</p>
                    </div>
                ))}
            </div>
            {/* steps and details */}
                                ...
                                <div className="flex gap-8">
                                    ...
                                    <div className="flex flex-col justify-between">
                                        <div className="flex flex-col gap-1">
                                            <p className="font-sm font-medium">{item.name}</p>
